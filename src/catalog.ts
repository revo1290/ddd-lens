...
export const DIMENSIONS: ReadonlyArray<{ id: DimensionId; title: string; weight: number }> = [
...
export const CRITERIA: ReadonlyArray<CriterionDefinition> = [
  {
...
export function criterionById(id: string): CriterionDefinition | undefined {
